...
const goodScanRoutes = require("./goodscan.routes");
...
router.get("/packages/goodos-topbar-widget-3.0.0.tgz", (req, res) => {
  ...
  res.sendFile(
    path.join(
      __dirname,
      "../public/packages/goodos-topbar-widget-3.0.0.tgz",
    ),
  );
});

router.get("/packages/goodos-topbar-widget-4.1.0.tgz", (req, res) => {
  res.set("Cache-Control", "public, max-age=31536000, immutable");
  res.set("Cross-Origin-Resource-Policy", "cross-origin");
  res.type("application/gzip");
  res.sendFile(
    path.join(
      __dirname,
      "../public/packages/goodos-topbar-widget-4.1.0.tgz",
    ),
  );
});

router.get("/packages/goodos-topbar-widget-4.2.0.tgz", (req, res) => {
  res.set("Cache-Control", "public, max-age=31536000, immutable");
  res.set("Cross-Origin-Resource-Policy", "cross-origin");
  res.type("application/gzip");
  res.sendFile(
    path.join(
      __dirname,
      "../public/packages/goodos-topbar-widget-4.2.0.tgz",
    ),
  );
});

router.get("/packages/goodos-topbar-widget-4.3.0.tgz", (req, res) => {
  res.set("Cache-Control", "public, max-age=31536000, immutable");
  res.set("Cross-Origin-Resource-Policy", "cross-origin");
  res.type("application/gzip");
  res.sendFile(
    path.join(
      __dirname,
      "../public/packages/goodos-topbar-widget-4.3.0.tgz",
    ),
  );
});

router.get("/packages/goodos-topbar-widget-4.4.0.tgz", (req, res) => {
  res.set("Cache-Control", "public, max-age=31536000, immutable");
  res.set("Cross-Origin-Resource-Policy", "cross-origin");
  res.type("application/gzip");
  res.sendFile(
    path.join(
      __dirname,
      "../public/packages/goodos-topbar-widget-4.4.0.tgz",
    ),
  );
});
...
router.get("/packages/goodos-topbar-widget-4.7.0.tgz", (req, res) => {
  res.set("Cross-Origin-Resource-Policy", "cross-origin");
  res.set("Cache-Control", "public, max-age=31536000, immutable");
  res.type("application/gzip");
  res.sendFile(
    path.resolve(
      __dirname,
      "../public/packages/goodos-topbar-widget-4.7.0.tgz",
    ),
  );
});

router.get("/packages/goodos-topbar-widget-4.8.0.tgz", (req, res) => {
  res.set("Cross-Origin-Resource-Policy", "cross-origin");
  res.set("Cache-Control", "public, max-age=31536000, immutable");
  res.type("application/gzip");
  res.sendFile(
    path.resolve(
      __dirname,
      "../public/packages/goodos-topbar-widget-4.8.0.tgz",
    ),
  );
});
...
router.use("/api/goodbuilder", goodbuilderRoutes);
...
router.use(
  ...
  goodbaseEcosystemRoutes.clientRouter
);
router.use(
  "/api/goodbase/v1/ecosystem",
  goodbaseEcosystemRoutes.adminRouter
);
router.use(
...
router.use(
  ...
  goodbaseProductRoutes.publicRouter
);
router.use(
  "/api/goodbase/v1/product",
