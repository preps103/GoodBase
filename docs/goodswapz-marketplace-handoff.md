...
2. Run the standard GoodBase build. It executes the advisory-locked,
   idempotent `scripts/apply-goodswapz-marketplace-migration.js` runner and
   verifies the resulting schema before any process restart.
3. Configure:
